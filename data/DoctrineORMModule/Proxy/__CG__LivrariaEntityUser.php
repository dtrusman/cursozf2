...
class User extends \Livraria\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Livraria\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Livraria\\Entity\\User' . "\0" . 'nome', '' . "\0" . 'Livraria\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Livraria\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Livraria\\Entity\\User' . "\0" . 'salt');
        }
