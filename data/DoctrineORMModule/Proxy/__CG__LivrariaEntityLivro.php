...
class Livro extends \Livraria\Entity\Livro implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Livraria\\Entity\\Livro' . "\0" . 'id', '' . "\0" . 'Livraria\\Entity\\Livro' . "\0" . 'nome', '' . "\0" . 'Livraria\\Entity\\Livro' . "\0" . 'categoria', '' . "\0" . 'Livraria\\Entity\\Livro' . "\0" . 'autor', '' . "\0" . 'Livraria\\Entity\\Livro' . "\0" . 'isbn', '' . "\0" . 'Livraria\\Entity\\Livro' . "\0" . 'valor');
        }
